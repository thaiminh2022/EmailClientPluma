            ...
            try
            {
                foreach (var m in mails)
                {
                    ...
                    var emailId = await connection.ExecuteScalarAsync<int>(
                        ...
                        new
                        {
                            ProviderMessageId = msgId.ProviderMessageId,
                            ProviderThreadId = msgId.ProviderThreadId,
                            ProviderHistoryId = msgId.ProviderHistoryId,
                            InternetMessageId = msgId.InternetMessageId,
                            FolderFullName = msgId.FolderFullName,
                            Provider = (int)msgId.Provider,
